...
<table cellpadding="0" cellspacing="1" class="grid" width="100%">
	<tr>
		...
		<td colspan="2" rowspan="7"><img id="imgTouxiang" width="200px"
										 height="200px" src="${pageContext.request.contextPath}${requestScope.huiyuan.touxiang}" /></td>
	</tr>
	...
	<tr>
		...
		<td><fmt:formatDate value="${requestScope.huiyuan.regdate}" pattern="yyyy-MM-dd hh:mm:ss"/></td>
	</tr>
	<tr>
