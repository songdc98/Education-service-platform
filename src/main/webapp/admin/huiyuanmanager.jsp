...
<div class="search-options">
	<form id="searchForm"
		...
		<table class="grid" cellspacing="0" width="100%">
			<tbody>
			<tr>
				<td>客户账号 <input name="accountname" value="${accountname}"
...
<table id="module" width="100%" border="0" cellspacing="0"
	...
	<c:forEach var="temhuiyuan" items="${listhuiyuan}">
		<tr>
			...
			<td>
				<a class="orange-href" href="huiyuandetails.jsp?id=${temhuiyuan.id}&seedid=301">查看</a>
			</td>
		</tr>
	</c:forEach>
	</tbody>
