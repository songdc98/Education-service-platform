...
<script type="text/javascript">
			$(function() {
				$("#btnDelete").click(function(){
					...
					$.ajax({
						url: "${pageContext.request.contextPath}/admin/jiaodiantumanager.do?actiontype=delete",
						method: 'post',
						data: ids,
				...
				<tbody>
					...
					<c:forEach var="temjiaodiantu" items="${listjiaodiantu}">
						<tr>
							...
							<td><img src='${pageContext.request.contextPath}${temjiaodiantu.tupian}' width="120" height="60"/></td>
