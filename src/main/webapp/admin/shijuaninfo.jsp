...
<%
    ...
    if (sjid != null) {
        paperVo = shijuanSrv.getPaper(Integer.parseInt(sjid));
...
<div class="search-title">
    <h2>
        ${requestScope.shijuan.title} 满分:(${requestScope.shijuan.zongfen}分)
    </h2>
    <div class="description">
        试卷状态: <c:if test="${requestScope.shijuan.state==1}">
        待组卷
    </c:if>
        ...
        <c:forEach varStatus="status" var="ceshiti" items="${pmCeshiti.questions}">
            ...
            <tr>
                <td>
                    ...
                    A:<input name="${ceshiti.id}" checked="checked" type="radio" value="A"/>
                        ${ceshiti.choicea}
            ...
            <tr>
                <td>
                    ...
                    B:<input name="${ceshiti.id}" checked="checked" type="radio" value="B"/>
                        ${ceshiti.choiceb}
            ...
            <tr>
                <td>
                    ...
                    C:<input name="${ceshiti.id}" checked="checked" type="radio" value="C"/>
                        ${ceshiti.choicec}
            ...
            <tr>
                <td>
                    ...
                    D:<input name="${ceshiti.id}" checked="checked" type="radio" value="D"/>
                        ${ceshiti.choiced}
