		...
		<script type="text/javascript">
			$(function() {
				$("#btnDelete").click(function(){
					...
					$.ajax({
						url: "${pageContext.request.contextPath}/admin/shoucangmanager.do?actiontype=delete",
						method: 'post',
						data: ids,
							...
							<tbody>
								<tr>
									<td>名称 <input name="bookname" value="${bookname}"
										...
										type="hidden" name="hyid" value="${sessionScope.huiyuan.id}" /> <input
				...
				<table id="shoucang" width="100%" border="0" cellspacing="0"
					...
					<tbody>
						...
						<tr>
							...
							<td><%=temshoucang.getTargetname()%></td>
